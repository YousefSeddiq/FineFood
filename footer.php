<section class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="#" class="links"> <i class="fas fa-envelope"></i> finefood@outlook.com </a>
            ...
            <div class="box">
                ...
                <a href="index.php#products" class="links"> <i class="fas fa-arrow-right"></i> products </a>
                <a href="index.php#categories" class="links"> <i class="fas fa-arrow-right"></i> categories </a>
                <a href="registration.php" class="links"> <i class="fas fa-arrow-right"></i> login/signup </a>
                <a href="contactUs.php" class="links"> <i class="fas fa-arrow-right"></i> contact us </a>
                <a href="aboutUs.php" class="links"> <i class="fas fa-arrow-right"></i> about </a>
            </div>
